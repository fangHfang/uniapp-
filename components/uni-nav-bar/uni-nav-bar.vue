<template>
	<view>
		<view class="status-bar-placeholder" :class="{'status-bar-fixed': fixed}" :style="{ 'background-color': backgroundColor,'height':statusBarHeight+'px' }"/>
		<view class="uni-navbar">
			...
			<view class="uni-navbar__placeholder" v-if="fixed">
				...
				<!-- <view class="status-bar-placeholder" :style="{ 'background-color': backgroundColor }"/>
				<view class="uni-navbar__placeholder-view" :style="{ 'background-color': backgroundColor }" /> -->
			</view>
		</view>
	</view>
</template>
