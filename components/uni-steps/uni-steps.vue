			...
			<view :class="[direction==='column'?'uni-steps__column-container':'uni-steps__row-container']">
				<view :class="[direction==='column'?'uni-steps__column-line-item':'uni-steps__row-line-item']" v-for="(item,index) in options"
				 :key="index">
					...
					<view :class="[direction==='column'?'uni-steps__column-check':'uni-steps__row-check']" v-if="index === active || activeArr.includes(index)">
						<uni-icons :color="activeColor" type="circle-filled" size="21"></uni-icons>
					</view>
...
<style lang="scss" scoped>
	...
	.uni-steps__row-line-item:nth-last-of-type(1) .uni-steps__row-line--after {
		visibility: hidden;
	}
	...
	.uni-steps__row-line-item:nth-of-type(1) .uni-steps__row-line--before {
		visibility: hidden;
	}
