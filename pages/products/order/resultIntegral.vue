					...
					<template slot="body">
						<view class="flex a-center j-center flex-column w">
							...
							<view style="padding:20rpx 0;">
								<text class="text-primary" style="font-size:80rpx;font-weight: 600;">{{orderInfo.consumeIntegrationAmount}}</text>
							</view>
						</view>
					</template>
				</uni-list-item>
	...
	export default {
      ...
      this.orderInfo = JSON.parse(options.orderInfo)
		...
		methods: {
			...
			toOrder(){
				uni.reLaunch({
				    url: '/pages/my-pages/integral/list/integral-list?tabIndex=1'
				});
			},
