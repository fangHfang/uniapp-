<template>
	<view class="page">
		<view id='pageHeader' class="page-header">
			<view class="header">
				...
				<view class="header-tab flex a-center j-center flex-column">
					<view class="available-title">可用积分</view>
					<view class="available-credit">{{availableRebates}}</view>
				</view>
			</view>
			<view class="tab flex a-center j-center">积分明细</view>
		...
		<mx-date-picker :show="showPicker" :type="type" :value="value" :show-tips="true" :begin-text="'开始日期'" :end-text="'结束日期'"
