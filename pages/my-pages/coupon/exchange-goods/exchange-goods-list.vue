<template>
	<view class="page">
		...
		<view class="flex search-box">
			<uni-search-bar class="search-bar" placeholder="商品名称/品牌/规格/分类"  :radius="20" type="" cancelButton="none" />
		</view>
		<view class="mescroll-uni-box">
			<view class="rule">
				<text>满{{tabs[tabIndex].baseNumber}}可兑换</text>
			</view>
			<mescroll-uni
				ref="mescrollRef"
				class="mescroll-uni"
					...
					<view
						...
						<view class="seckill-info">
							<view class="seckill-info-top">
								...
								<text class="seckill-brand">{{item.promotionDesc}}</text>
							</view>
	...
	export default {
		...
		data() {
			return {
				...
				searchData:{
					// 活动类型编码
					categoryNo:'PCNO2102081607547BSW',
					// 排序字段
					'page.field':"",
					// 排序规则
					'page.order':"",
